<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="HNNDB09_DOME.WEB.PAGE.XS.list" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#GridView1').datagrid({
                ...
                {
                    field: 'HNN09_XS_SEX', title: '性别', width: 80,
                ...
                { field: 'HNN09_XS_AGE', title: '年龄', width: 100 },
                { field: 'HNN09_XS_PHONE', title: '电话', width: 100 }
                ]],
                //数据加载完成回掉的函数
